...
Protected Module SOSConstraintKit
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Function BottomAnchor(extends view as RectControl) As SOSLayoutYAxisAnchor
		  // The bottom anchor of the DesktopUIControl
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Function BottomAnchor(extends view as Window) As SOSLayoutYAxisAnchor
		  // The bottom anchor of the DesktopUIControl
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Function CenterXAnchor(extends view as RectControl) As SOSLayoutXAxisAnchor
		  // The Center X anchor of the DesktopUIControl
		  
		  #If TargetMacOS
		    // @property(nonatomic, readonly, strong) NSLayoutXAxisAnchor *centerXAnchor;
		    Declare Function getCenterXAnchor Lib "Foundation" Selector "centerXAnchor" (obj As Integer) As Ptr
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Function CenterXAnchor(extends view as Window) As SOSLayoutXAxisAnchor
		  // The Center X anchor of the DesktopWindow
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Function CenterYAnchor(extends view as RectControl) As SOSLayoutYAxisAnchor
		  // The Center Y anchor of the DesktopUIControl
		  
		  #If TargetMacOS
		    // @property(nonatomic, readonly, strong) NSLayoutYAxisAnchor *centerYAnchor;
		    Declare Function getCenterYAnchor Lib "Foundation" selector "centerYAnchor" (obj as Integer) as Ptr
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Function CenterYAnchor(extends view as Window) As SOSLayoutYAxisAnchor
		  // The Center Y anchor of the DesktopWindow
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Function FirstBaselineAnchor(extends view as RectControl) As SOSLayoutYAxisAnchor
		  // The First Baseline anchor of the DesktopUIControl
		  
		  #If TargetMacOS
		    // @property(nonatomic, readonly, strong) NSLayoutYAxisAnchor *firstBaselineAnchor;
		    Declare Function getFirstBaselineAnchor Lib "Foundation" Selector "firstBaselineAnchor" (obj As Integer) As Ptr
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Function HeightAnchor(extends view as RectControl) As SOSLayoutDimension
		  // The Height anchor of the DesktopUIControl
		  
		  #If TargetMacOS
		    // @property(nonatomic, readonly, strong) NSLayoutDimension *heightAnchor;
		    Declare Function getHeightAnchor Lib "Foundation" Selector "heightAnchor" (obj As Integer) As Ptr
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Function HeightAnchor(extends view as Window) As SOSLayoutDimension
		  // The Height anchor of the Window
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Function LastBaselineAnchor(extends view as RectControl) As SOSLayoutYAxisAnchor
		  // The Last Baseline anchor of the RectControl
		  
		  #If TargetMacOS
		    // @property(nonatomic, readonly, strong) NSLayoutYAxisAnchor *lastBaselineAnchor;
		    Declare Function getLastBaselineAnchor Lib "Foundation" Selector "lastBaselineAnchor" (obj As Integer) As Ptr
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetConsole and (Target64Bit)) or  (TargetWeb and (Target64Bit)) or  (TargetDesktop and (Target64Bit))
		Function LeadingAnchor(extends view as RectControl) As SOSLayoutXAxisAnchor
		  // The Leading anchor of the control
		  
		  #If TargetMacOS
		    // @property(nonatomic, readonly, strong) NSLayoutXAxisAnchor *trailingAnchor;
		    Declare Function getLeadingAnchor Lib "Foundation" Selector "leadingAnchor" (obj As integer) As Ptr
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Function LeadingAnchor(extends view as Window) As SOSLayoutXAxisAnchor
		  // The Leading anchor of the DesktopWindow
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Function LeftAnchor(extends view as RectControl) As SOSLayoutXAxisAnchor
		  // The Left anchor of the DesktopUIControl
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Function LeftAnchor(extends view as Window) As SOSLayoutXAxisAnchor
		  // The Left anchor of the Window
	...
	#tag Method, Flags = &h21, CompatibilityFlags = (TargetDesktop and (Target64Bit)) or  (TargetIOS and (Target64Bit))
		Attributes( Hidden ) Private Function LeftAnchor(view as integer) As SOSLayoutXAxisAnchor
		  #If TargetiOS Or TargetMacOS
		    // @property(nonatomic, readonly, strong) NSLayoutXAxisAnchor *leftAnchor;
		    Declare Function getLeftAnchor Lib "Foundation" Selector "leftAnchor" (obj As integer) As Ptr
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Function RightAnchor(extends view as RectControl) As SOSLayoutXAxisAnchor
		  // The Right anchor of the DesktopUIControl
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Function RightAnchor(extends view as Window) As SOSLayoutXAxisAnchor
		  // The Right anchor of the Window
	...
	#tag Method, Flags = &h21, CompatibilityFlags = (TargetDesktop and (Target64Bit)) or  (TargetIOS and (Target64Bit))
		Attributes( Hidden ) Private Function RightAnchor(view as integer) As SOSLayoutXAxisAnchor
		  #If TargetiOS Or TargetMacOS
		    // @property(nonatomic, readonly, strong) NSLayoutXAxisAnchor *rightAnchor;
		    Declare Function getrightAnchor Lib "Foundation" Selector "rightAnchor" (obj As integer) As Ptr
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Function SafeAreaLayoutGuide(extends view as RectControl) As SOSLayoutGuide
		  // The Safe Area Layout Guide anchor of the DesktopUIControl
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Function SafeAreaLayoutGuide(extends view as Window) As SOSLayoutGuide
		  // The Safe Area Layout Guide anchor of the Window
	...
	#tag Method, Flags = &h21, CompatibilityFlags = (TargetDesktop and (Target64Bit)) or  (TargetIOS and (Target64Bit))
		Attributes( Hidden ) Private Function SafeAreaLayoutGuide(view as integer) As SOSLayoutGuide
		  #If TargetiOS Or TargetMacOS
		    // @property(nonatomic, readonly, strong) UILayoutGuide *safeAreaLayoutGuide;
		    Declare Function getSafeAreaLayoutGuide Lib "Foundation" Selector "safeAreaLayoutGuide" (obj As integer) As Ptr
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Function TopAnchor(extends view as RectControl) As SOSLayoutYAxisAnchor
		  // The Top anchor of the DesktopUIControl
		  
		  #If TargetMacOS
		    // @property(nonatomic, readonly, strong) NSLayoutYAxisAnchor *topAnchor;
		    Declare Function getTopAnchor Lib "Foundation" Selector "topAnchor" (obj As integer) As Ptr
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Function TopAnchor(extends view as Window) As SOSLayoutYAxisAnchor
		  // The Top anchor of the DesktopWindow
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Function TrailingAnchor(extends view as RectControl) As SOSLayoutXAxisAnchor
		  // The Trailing anchor of the DesktopUIControl
		  
		  #If TargetMacOS
		    // @property(nonatomic, readonly, strong) NSLayoutXAxisAnchor *trailingAnchor;
		    Declare Function getTrailingAnchor Lib "Foundation" Selector "trailingAnchor" (obj As integer) As Ptr
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Function TrailingAnchor(extends view as Window) As SOSLayoutXAxisAnchor
		  // The Trailing anchor of the DesktopWindow
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Function WidthAnchor(extends view as RectControl) As SOSLayoutDimension
		  // The Width anchor of the DesktopUIControl
		  
		  #If TargetMacOS
		    // @property(nonatomic, readonly, strong) NSLayoutDimension *widthAnchor;
		    Declare Function getWidthAnchor Lib "Foundation" Selector "widthAnchor" (obj As Integer) As Ptr
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Function WidthAnchor(extends view as Window) As SOSLayoutDimension
		  // The Width anchor of the DesktopWindow
	...
	#tag Method, Flags = &h21, CompatibilityFlags = (TargetDesktop and (Target64Bit))
		Private Function WindowToView(w as Window) As Integer
		  Dim p As Integer = w.Handle
		  #If TargetMacOS
		    If Not w IsA ContainerControl Then
		      // @property(strong) __kindof NSView *contentView;
